...
const AddProduct = () => {
    ...
    const { name, description, price, categories, category, shipping,
        quantity, photo, loading, error, createdProduct, redirectToProfile, formData } = values;
    ...
    const newPostForm = () => (
        <form className="mb-3" onSubmit={clickSubmit}>
            ...
            <div className="form-group">
                <label className="text-muted">Qunatity</label>
    ...
    return (
        <Layout title="Add new product" description={`Hey ${user.name},ready to add new product`}>
            <div className="row">
